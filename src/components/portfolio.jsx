...
export default function Portfolio() {
  const projects = [
    ...
    },
    {
      ...
      category: "Web Development",
      image: "/placeholder.svg?height=300&width=400",
      description: "A responsive website for a restaurant with online reservation system.",
      demoLink: "#",
      githubLink: "#",
    },
    {
      ...
      category: "Web Application",
      image: "/placeholder.svg?height=300&width=400",
      description: "A weather forecast application with interactive maps and data visualization.",
      demoLink: "#",
      githubLink: "#",
    },
    {
